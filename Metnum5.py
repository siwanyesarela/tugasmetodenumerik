...
st.markdown(
    ...
    <div class="main-title">Aplikasi Metode Numerik</div>
    <div class="sub-title">Visualisasi Interaktif dengan Estetika Modern</div>
    """,
...
# Tombol hitung
if st.sidebar.button("Hitung", key="calculate_button"):
    try:
